...
from derivates.Standart22050hz_Highpass100Hz import Standart22050hz_Highpass100Hz as Derivative
import argparse
...
parser.add_argument(
    ...
    type=str,
    nargs="?",
    default="ammod25-britz-train-22kHz.csv",
